...
<%--<div class="store-sub-nav-area">
    <div class="container store-sub-nav">
        <div class="sub-menu-list">
            <a href="${pageContext.request.contextPath}/store.htm" class="${subMenu eq 'home' ? 'active' : ''}">
                쇼핑홈
            </a>

            <a href="${pageContext.request.contextPath}/category.htm?category_id=${empty param.category_id ? '1' : param.category_id}"
               class="${subMenu eq 'category' ? 'active' : ''}">
                카테고리
            </a>
            <a href="#" data-menu="store">베스트</a>
            <a href="#" data-menu="store">오늘의딜</a>
            <a href="#" data-menu="store">단독상품</a>
            <a href="#" data-menu="store">오마트</a>
            <a href="#" data-menu="store">원하는날도착</a>
            <a href="#" data-menu="store">오!쇼룸</a>
            <a href="#" data-menu="store">기획전</a>
        </div>
...
<main class="container store-main">
    ...
    <section class="banner-section">
        <div class="banner-box">
            <a href="productDetail.htm?product_id=3377041">
        ...
        <div class="slider-wrap">
            ...
            <div class="category-slider" id="cat-slider">
                ...
                <div class="category-item">
                    ...
                    <span class="category-name">가구</span></div>
                <div class="category-item">
                    <div class="category-icon2" style="color:#FF7777;">⚡</div>
                    <span class="category-name">주방용품</span></div>
                <!-- 2열 -->
                <div class="category-item">
                    <div class="category-icon3">🪑</div>
                    <span class="category-name">수납/정리</span></div>
                <div class="category-item">
                    <div class="category-icon4" style="color:#D4AF37;">🏅</div>
                    <span class="category-name">BEST</span></div>
                <div class="category-item">
                     <div class="category-icon5" style="color:#D4AF37;">😀</div>
...
<script>
    ...
    $(".category-icon5").on("click",function() {
        location.href="/viewall.htm";
    })
</script>