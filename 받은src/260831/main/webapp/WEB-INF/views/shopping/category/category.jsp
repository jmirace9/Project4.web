...
<aside class="sidebar">
    ...
    <div class="selected-category-area">
        ...
        <c:forEach var="main" items="${categories}">
            ...
            <c:if test="${main.parentId == null}">
                ...
                <c:if test="${selectedCategoryId == main.categoryId}">
                ...
                <c:forEach var="middle" items="${categories}">
                    ...
                    <c:if test="${middle.parentId == main.categoryId}">

                        <c:if test="${selectedCategoryId == middle.categoryId}">
                            <c:set var="mainOpen" value="true" />
                        </c:if>
                        ...
                        <c:forEach var="sub" items="${categories}">
                            ...
                            <c:if test="${sub.parentId == middle.categoryId}">

                                <c:if test="${selectedCategoryId == sub.categoryId}">
                                    <c:set var="mainOpen" value="true" />
                                </c:if>
                ...
                <c:if test="${mainOpen}">
                    ...
                    <div class="category-panel">
                        ...
                        <div class="sidebar-menu">
                            ...
                            <c:forEach var="middle" items="${categories}">
                                ...
                                <c:if test="${middle.parentId == main.categoryId}">
                                    ...
                                    <c:forEach var="subCheck" items="${categories}">
                                        ...
                                        <c:if test="${subCheck.parentId == middle.categoryId}">
                                    ...
                                    <c:if test="${hasSub}">
                                        ...
                                        <div class="sidebar-item">
                                            ...
                                            <a href="${pageContext.request.contextPath}/shopping/category/category.htm?category_id=${middle.categoryId}"
                                               class="middle-category ${selectedCategoryId == middle.categoryId ? 'selected' : ''}">
                                        ...
                                        <c:forEach var="subCheck" items="${categories}">
                                            ...
                                            <c:if test="${subCheck.parentId == middle.categoryId
                                                       && selectedCategoryId == subCheck.categoryId}">
                                        ...
                                        <div class="sidebar-submenu ${middleOpen ? 'open' : ''}">
                                            ...
                                            <c:forEach var="sub" items="${categories}">
                                                ...
                                                <c:if test="${sub.parentId == middle.categoryId}">
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/shopping/category/category.htm?category_id=${sub.categoryId}"
                                                       class="subcategory ${selectedCategoryId == sub.categoryId ? 'selected' : ''}"
                            ...
                            <c:if test="${main.categoryId == 10000000}">
                            ...
                            <c:if test="${main.categoryId == 16000000}">
                            ...
                            <c:if test="${main.categoryId == 13000000}">
    ...
    <div class="sidebar-notselected">
        ...
        <c:forEach var="main" items="${categories}">
            ...
            <c:if test="${main.parentId == null
                       && selectedCategoryId != main.categoryId}">

                <a href="${pageContext.request.contextPath}/shopping/category/category.htm?category_id=${main.categoryId}"
    ...
    <script>
    	$(".category-enabled").click(function () {
			...
			location.href = "${pageContext.request.contextPath}/shopping/category/category.htm?category_id="+categoryId;
    	})
    ...
    <div class="main-content">
        ...
        <div class="product-grid">
	        ...
	        <div class="product-card"
             onclick="location.href='${pageContext.request.contextPath}/shopping/product/productDetail.htm?product_id=${product.product_id}'">
